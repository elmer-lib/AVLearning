 ...
 * @param flags
 */
AVEGLCore::AVEGLCore(EGLContext sharedContext, int flags) {
 ...
 * @return
 */
bool AVEGLCore::init(EGLContext sharedContext, int flags) {
 ...
 * @return
 */
EGLConfig AVEGLCore::getConfig(int flags, int version) {
 ...
 * @return
 */
EGLContext AVEGLCore::getEGLContext() {
    return mEGLContext;
}
 ...
 * @param eglSurface
 */
void AVEGLCore::releaseSurface(EGLSurface eglSurface) {
 ...
 * @return
 */
EGLSurface AVEGLCore::createWindowSurface(ANativeWindow *surface) {
    assert(surface != NULL);
    if (surface == NULL) {
 ...
 * @return
 */
EGLSurface AVEGLCore::createOffscreenSurface(int width, int height) {
    int surfaceAttribs[] = {
            EGL_WIDTH, width,
            EGL_HEIGHT, height,
            EGL_NONE
 ...
 * @param eglSurface
 */
void AVEGLCore::makeCurrent(EGLSurface eglSurface) {
    if (mEGLDisplay == EGL_NO_DISPLAY) {
 ...
 * @param readSurface
 */
void AVEGLCore::makeCurrent(EGLSurface drawSurface, EGLSurface readSurface) {
    if (mEGLDisplay == EGL_NO_DISPLAY) {
        LOGD("Note: makeCurrent w/o display.");
    }
 ...
 *
 */
void AVEGLCore::makeNothingCurrent() {
 ...
 * @return
 */
bool AVEGLCore::swapBuffers(EGLSurface eglSurface) {
 ...
 * @param nsecs
 */
void AVEGLCore::setPresentationTime(EGLSurface eglSurface, long nsecs) {
 ...
 * @return
 */
bool AVEGLCore::isCurrent(EGLSurface eglSurface) {
 ...
 * @return
 */
int AVEGLCore::querySurface(EGLSurface eglSurface, int what) {
    int value;
 ...
 * @return
 */
const char* AVEGLCore::queryString(int what) {
 ...
 * @param msg
 */
void AVEGLCore::checkEglError(const char *msg) {
    int error;
