...
// https://blog.csdn.net/zjy764219923/article/details/120065864

#ifndef AVLEARNING_AVEGLCORE_H
#define AVLEARNING_AVEGLCORE_H
...
public:
    AVEGLCore();
    ~AVEGLCore();
    AVEGLCore(EGLContext sharedContext, int flags);
